...
def main(parser_data):
    ...
    val_dataset = maskDetectionDataset(mask_root, data_transform["valid"], "valid.txt")
    ...
    for epoch in range(parser_data.start_epoch, parser_data.epochs):
        ...
        torch.save(
            save_files,
            f"./save_weights/resNetHDCFpn-model-Augment-{epoch}.pth",
        )
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='./MaskDatasets_Augment', help='dataset')
    # 检测目标类别数(不包含背景)
